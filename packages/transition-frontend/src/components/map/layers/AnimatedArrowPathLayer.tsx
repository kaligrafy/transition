...
export type AnimatedArrowPathProps = {
    time: number;
};
...
export type AnimatedArrowPathLayerProps<DataT = unknown> = _AnimatedArrowPathLayerProps<DataT> & PathLayerProps<DataT>;
...
export default class AnimatedArrowPathLayer<DataT = any, ExtraProps extends object = object> extends PathLayer<
    DataT,
    Required<_AnimatedArrowPathLayerProps<DataT>> & ExtraProps
> {
    ...
    draw(params) {
        ...
        params.uniforms.time = performance.now() % 10000/*00*/ / 10000/*00*/;
        super.draw(params);
